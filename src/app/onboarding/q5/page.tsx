...
export default async function Q5Page() {
  ...
  if (!data.q4_customer_situation) redirect('/onboarding/q4')
  ...
  return (
    <ClickQuestionPage
      ...
      questionNumber={5}
      totalQuestions={7}
      initialAnswer={data.q5_cancellations}
      saveKey="q5_cancellations"
      nextPath="/onboarding/q6"
    />
  )
}
